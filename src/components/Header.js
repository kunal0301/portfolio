                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <a href="#home" className="rounded-md px-3 py-2 text-sm font-medium text-white" aria-current="page">Kunal Srivastava</a>
                                    <a href="#home" className="text-gray-300 hover:text-white px-3 py-2 text-base font-medium">Home</a>
