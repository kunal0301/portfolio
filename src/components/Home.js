...
function Home() {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-slate-900 flex items-center justify-center">
      <div className="text-center max-w-4xl mx-auto px-6">
        ...
        <div className={`transition-all duration-1000 transform ${isTypingComplete ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className={`text-lg text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-300 transform ${isTypingComplete ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
